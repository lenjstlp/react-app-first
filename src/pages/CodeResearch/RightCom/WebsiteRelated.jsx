...
function WebsiteRelated() {
  return (
    <div className='w-[100%] mt-[10px]'>
      ...
      <div className='flex text-[#8a919f] text-[14px] px-[10px] cursor-pointer'>
        <div>举报邮箱：</div>
        <div>lenjstlp@163.com</div>
      </div>
      <div className='flex mt-[10px] text-[#8a919f] text-[14px] px-[10px] cursor-pointer'>
        <div>捐助：</div>
        <div className='flex'>
          <div className='flex flex-col mr-[10px]'>
            <div className='mb-[5px] pl-[12px]'>微信</div>
            <QRCode value='-' size={100} color='#57bb40' bgColor='#f5f5f5' />
          </div>
          <div className='flex flex-col'>
            <div className='mb-[5px] pl-[12px]'>支付宝</div>
            <QRCode value='-' size={100} color='#1677ff' bgColor='#f5f5f5' />
          </div>
        </div>
      </div>
    </div>
