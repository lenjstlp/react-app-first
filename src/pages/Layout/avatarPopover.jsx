    ...
    const avatarContent = (
        <div className='w-[160px] cursor-pointer'>
            <div className='h-[55px] flex flex-col'>
                <div className='text-[#002fa7] self-center text-[16px]'>{ userInfo.name }</div>
            ...
            <div style={{ borderRadius: borderRadiusLG }} className='h-[39px] flex items-center justify-between px-[10px] hover:bg-[#e6f4ff] hover:text-[#1677ff]'>
