...
import { Card, Button, Form, Input, message, theme, Select } from 'antd'
                ...
                return (
                  <div
                    style={{
                      ...
                      borderRight:
                        loginModeOptions.length !== index + 1
                          ? '1px solid #e3e5e7'
                          : ''
                    }}
                    key={i.key}
            ...
            <div className='pl-[50px] border-l-1 border-[#e3e5e7]'>
              {loginMode === 'password' ? (
                <Form
                  ...
                  <Form.Item>
                    <div className='flex justify-between'>
                      <Button className='w-[49%]'>注 册</Button>
                      <Button
                        className='w-[49%]'
                        type='primary'
                        htmlType='submit'>
